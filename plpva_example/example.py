"""
Example to use plfit0, plfit, plpva_example, plplot (discrete data)

Calls plfit0.plfit0, plfit.plfit, plpva_example.plpva_example and plplot.plplot in order
...
# import plfit0
from plpva_example import plfit0

# import plfit_local
from plpva_example import plfit_local

import plfit
from plpva_example import plpva
# import plpva
# import plplot
from plpva_example import plplot


# import plpva_example.plplot
...
def power_law(x, variable, subject, radius=0.5, number_of_sets=100):
    ...
    alpha, xmin, L = plfit_local.plfit(x, vec=alpha_range, nosmall=False, finite=True)
